    ...
    <div id="banner" className='relative'>
        <div>
            <div className='content absolute min-h-full min-w-full z-20 top-0 pt-16 flex flex-col justify-start items-center'>
                <div className='super_heading pt-10 lg:pt-20'>
                ...
                <div className='sub_heading hidden sm:block pt-10 lg:pt-20 max-w-[40rem] px-2'>
                ...
                <div className='sub_heading pt-10 sm:pt-20 lg:pt-32 w-full flex justify-center items-center'>
