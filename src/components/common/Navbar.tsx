  ...
  return (
        <nav className="navbar navbar-sticky navbar-glass bg-[#fff] rounded-none">
            ...
            <div className="navbar-center">
                <div className="flex items-center input input-md justify-center bg-[#f5f5f5] border-none max-w-[40rem]">
                    <BsSearch className="text-brandColor w-5 h-5" />
                    <input placeholder="Search Bar - Product url or name" type="search" className="input input-md bg-[#f5f5f5] border-none max-w-[40rem]" />
                </div>

            </div>

            <div className="dropdown md:hidden pl-2">
                <label className="btn my-2" tabIndex={0}><MdOutlineArrowDropDownCircle className="w-6 h-6 text-brandColor" /></label>
